...
def run_single(cr, exchanges, universe_name, frequency, use_costs,
    ...
    print(format_metrics(metrics, "P/E Mean Reversion", "S&P 500"))
    ...
    if annual:
        print(f"\n  {'Year':<8} {'P/E Mean Reversion':>19} {'SPY':>10} {'Excess':>10}")
        print("  " + "-" * 50)
        for ar in annual:
            print(f"  {ar['year']:<8} {ar['portfolio']*100:>18.1f}% {ar['benchmark']*100:>9.1f}% "
