...
EXCHANGE_LABELS = {
    "NYSE_NASDAQ_AMEX": "PEG US (NYSE+NASDAQ+AMEX)",
    "BSE_NSE": "PEG India (BSE+NSE)",
    "JNB": "PEG South Africa (JSE)",
    "TSX": "PEG Canada (TSX)",
    "STO": "PEG Sweden (STO)",
    "OSL": "PEG Norway (OSL)",
...
def chart_comparison_cagr(filename):
    ...
    ax.set_title("PEG Ratio CAGR by Exchange (2000-2025)", fontsize=14, fontweight="bold", pad=15)
    ...
    fig.text(0.5, -0.02,
             "Data: Ceta Research | Same PEG screen, quarterly rebalance, equal weight. Local currency returns.",
             ha="center", fontsize=8, color="#7f8c8d")
...
def chart_comparison_drawdown(filename):
    ...
    ax.set_title("PEG Ratio Max Drawdown by Exchange (2000-2025)", fontsize=14, fontweight="bold", pad=15)
    ...
    fig.text(0.5, -0.02,
             "Data: Ceta Research | Same PEG screen, quarterly rebalance, equal weight.",
             ha="center", fontsize=8, color="#7f8c8d")
...
chart_cumulative(
    ...
    "Growth of $10,000: PEG Ratio US vs S&P 500 (2000-2025)",
    "NYSE + NASDAQ + AMEX"
)
chart_annual_bars(
    ["NYSE_NASDAQ_AMEX"], "us_annual_returns.png",
    "PEG Ratio US vs S&P 500: Year-by-Year Returns (2000-2025)",
    "NYSE + NASDAQ + AMEX"
)
...
chart_annual_bars(
    ...
    "PEG Ratio South Africa vs S&P 500: Year-by-Year Returns (2000-2025)",
    "JNB (returns in ZAR)"
)
...
print("  southafrica/1_southafrica_cumulative_growth.png, southafrica/2_southafrica_annual_returns.png")
