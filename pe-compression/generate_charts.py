"""Generate all P/E Compression charts for blog posts from exchange_comparison.json."""
...
EXCHANGE_LABELS = {
    ...
    "HKSE": "P/E Compression Hong Kong (HKSE)",
    "TAI": "P/E Compression Taiwan (TAI)",
    "SET": "P/E Compression Thailand (SET)",
    "XETRA": "P/E Compression Germany (XETRA)",
    "KSC": "P/E Compression Korea (KSC)",
    "TSX": "P/E Compression Canada (TSX)",
    "STO": "P/E Compression Sweden (STO)",
    "SIX": "P/E Compression Switzerland (SIX)",
    "JKT": "P/E Compression Indonesia (JKT)",
    "JNB": "P/E Compression South Africa (JNB)",
    "OSL": "P/E Compression Norway (OSL)",
    "SES": "P/E Compression Singapore (SES)",
    "MIL": "P/E Compression Italy (MIL)",
    "KLS": "P/E Compression Malaysia (KLS)",
    "WSE": "P/E Compression Poland (WSE)",
    "SAU": "P/E Compression Saudi Arabia (SAU)",
}
...
def chart_comparison_cagr(filename):
    ...
    ax.set_title("P/E Compression CAGR by Exchange (2000-2025)", fontsize=14, fontweight="bold", pad=15)
    ...
    fig.text(0.5, -0.02,
             "Data: Ceta Research | Same P/E compression screen, annual rebalance, equal weight. Local currency returns.",
             ha="center", fontsize=8, color="#7f8c8d")
...
def chart_comparison_drawdown(filename):
    ...
    ax.set_title("P/E Compression Max Drawdown by Exchange (2000-2025)", fontsize=14, fontweight="bold", pad=15)
    ...
    fig.text(0.5, -0.02,
             "Data: Ceta Research | Same P/E compression screen, annual rebalance, equal weight.",
             ha="center", fontsize=8, color="#7f8c8d")
...
EXCHANGE_CHART_CONFIGS = [
    ...
    ("TAI", "taiwan", "TAI (returns in TWD, benchmark in USD)"),
    ...
    ("JKT", "indonesia", "JKT (returns in IDR, benchmark in USD)"),
    ("JNB", "southafrica", "JNB (returns in ZAR, benchmark in USD)"),
    ("OSL", "norway", "OSL (returns in NOK, benchmark in USD)"),
    ("SES", "singapore", "SES (returns in SGD, benchmark in USD)"),
    ("MIL", "italy", "MIL (returns in EUR, benchmark in USD)"),
    ("KLS", "malaysia", "KLS (returns in MYR, benchmark in USD)"),
    ("WSE", "poland", "WSE (returns in PLN, benchmark in USD)"),
    ("SAU", "saudi", "SAU (returns in SAR, benchmark in USD)"),
]
