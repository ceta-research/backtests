"""Generate all EV/EBITDA Sector-Relative charts for blog posts from exchange_comparison.json."""
...
EXCHANGE_LABELS = {
    ...
    "HKSE": "EV/EBITDA Relative Hong Kong (HKSE)",
    "TAI_TWO": "EV/EBITDA Relative Taiwan (TAI+TWO)",
    "SET": "EV/EBITDA Relative Thailand (SET)",
    "XETRA": "EV/EBITDA Relative Germany (XETRA)",
    "KSC": "EV/EBITDA Relative Korea (KSC)",
    "TSX": "EV/EBITDA Relative Canada (TSX)",
    "STO": "EV/EBITDA Relative Sweden (STO)",
    "SIX": "EV/EBITDA Relative Switzerland (SIX)",
    "OSL": "EV/EBITDA Relative Norway (OSL)",
    "JNB": "EV/EBITDA Relative South Africa (JNB)",
}
...
def chart_comparison_cagr(filename):
    ...
    ax.set_title("EV/EBITDA Sector-Relative CAGR by Exchange (2000-2025)", fontsize=14, fontweight="bold", pad=15)
    ...
    fig.text(0.5, -0.02,
             "Data: Ceta Research | Same sector-relative EV/EBITDA screen, annual rebalance, equal weight. Local currency returns.",
             ha="center", fontsize=8, color="#7f8c8d")
...
def chart_comparison_drawdown(filename):
    ...
    ax.set_title("EV/EBITDA Sector-Relative Max Drawdown by Exchange (2000-2025)", fontsize=14, fontweight="bold", pad=15)
    ...
    fig.text(0.5, -0.02,
             "Data: Ceta Research | Same sector-relative EV/EBITDA screen, annual rebalance, equal weight.",
             ha="center", fontsize=8, color="#7f8c8d")
...
print("Move charts to ts-content-creator/content/_current/timing-02-ev-ebitda-relative/blogs/{region}/")
