#!/usr/bin/env python3
"""
Generate charts for Earnings Growth Consistency strategy.
...
Charts are saved to earnings-consistency/charts/ and must be moved to:
  ts-content-creator/content/_current/growth-02-earnings-consistency/blogs/{region}/
...
STRATEGY_COLOR = "#2E7D32"    # Dark green (growth theme)
...
def main():
    ...
    print("Generating Earnings Consistency charts...")
    ...
    print("\nNext: Move charts to:")
    print("  ts-content-creator/content/_current/growth-02-earnings-consistency/blogs/{region}/")
