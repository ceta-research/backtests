#!/usr/bin/env python3
"""Run Low P/E backtest across all exchanges and merge into exchange_comparison.json.

Usage:
    source /Users/swas/Desktop/Swas/Kite/ATO_SUITE/.venv/bin/activate
    cd /Users/swas/Desktop/Swas/Kite/ATO_SUITE/ts-backtests
    python3 low-pe/run_all_exchanges.py
"""
...
def run_exchange(name, args):
    ...
    returns_file = RESULTS_DIR / f"returns_{name}.csv"
...
def main():
    print("Low P/E: Running backtests across all exchanges")
