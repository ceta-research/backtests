...
def run_single(cr, exchanges, universe_name, frequency, use_costs,
    ...
    print(format_metrics(metrics, "EV/EBITDA", benchmark_name))
    ...
    if annual:
        print(f"\n  {'Year':<8} {'EV/EBITDA':>12} {benchmark_name:>10} {'Excess':>10}")
        print("  " + "-" * 42)
        for ar in annual:
        ...
        for preset_name, preset_exchanges in GLOBAL_PRESETS:
            ...
            try:
                result = run_single(cr, preset_exchanges, uni_name, frequency,
                                    use_costs, rfr, mktcap_threshold, args.verbose,
                                    output_path, offset_days=offset_days)
                if result:
