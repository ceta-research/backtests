...
EXCHANGE_LABELS = {
    ...
    "BSE_NSE": "EV/EBITDA India (BSE+NSE)",
...
chart_cumulative(
    ...
    "Growth of $10,000: EV/EBITDA India vs S&P 500 (2000-2025)",
    "BSE + NSE (returns in INR, benchmark in USD)"
)
chart_annual_bars(
    ["BSE_NSE"], "india_annual_returns.png",
    "EV/EBITDA India vs S&P 500: Year-by-Year Returns (2000-2025)",
...
chart_cumulative(
    ...
    "Growth of $10,000: EV/EBITDA Canada vs S&P 500 (2000-2025)",
    "TSX (returns in CAD, benchmark in USD)"
)
chart_annual_bars(
    ["TSX"], "canada_annual_returns.png",
    "EV/EBITDA Canada vs S&P 500: Year-by-Year Returns (2000-2025)",
    "TSX (returns in CAD)"
)
...
chart_cumulative(
    ...
    "Growth of $10,000: EV/EBITDA Sweden vs S&P 500 (2000-2025)",
    "STO (returns in SEK, benchmark in USD)"
)
chart_annual_bars(
    ["STO"], "sweden_annual_returns.png",
    "EV/EBITDA Sweden vs S&P 500: Year-by-Year Returns (2000-2025)",
    "STO (returns in SEK)"
)
...
chart_cumulative(
    ...
    "Growth of $10,000: EV/EBITDA Italy vs S&P 500 (2000-2025)",
    "MIL (returns in EUR, benchmark in USD)"
)
chart_annual_bars(
    ["MIL"], "italy_annual_returns.png",
    "EV/EBITDA Italy vs S&P 500: Year-by-Year Returns (2000-2025)",
    "MIL (returns in EUR)"
)
...
chart_cumulative(
    ...
    "Growth of $10,000: EV/EBITDA Germany vs S&P 500 (2000-2025)",
    "XETRA (returns in EUR, benchmark in USD)"
)
chart_annual_bars(
    ["XETRA"], "germany_annual_returns.png",
    "EV/EBITDA Germany vs S&P 500: Year-by-Year Returns (2000-2025)",
