...
def run_single(cr, exchanges, universe_name, frequency, use_costs,
    ...
    print(format_metrics(metrics, "Value-Momentum", benchmark_name))
    ...
    if annual:
        ...
        print(f"\n  {'Year':<8} {'ValMom':>10} {bench_label:>10} {'Excess':>10}")
        print("  " + "-" * 40)
        for ar in annual:
    ...
    output["benchmark_symbol"] = benchmark_symbol
    output["benchmark_name"] = benchmark_name
    output["execution_model"] = exec_model
